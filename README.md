...
1. The program loads transaction records from a CSV file.
2. Each transaction is evaluated against predefined detection rules.
3. Transactions meeting suspicious criteria are flagged.
4. A summary report of flagged entries is printed or saved.
